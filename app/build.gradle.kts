...
android {
    ...
    buildFeatures {
        ...
        buildConfig = true // Enables the use of the BuildConfig class for the project.
    }
    composeOptions {
...
/**
 * получить ключ API Яндекс.Карт. Для отображение карты
 */
...
/**
 *получить ключ API Яндекс.Карт для геокодера - получения координат из адреса
 */
